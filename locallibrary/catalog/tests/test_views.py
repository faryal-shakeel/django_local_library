...
from django.contrib.auth.models import Permission  # to grant the renew permission
...
class LoanedBookInstancesByUserListViewTest(TestCase):
    def setUp(self):
        ...
        test_book.genre.set(genre_objects_for_book)  # m2m can't be set directly at create
        test_book.save()
    ...
    def test_only_borrowed_books_in_list(self):
        ...
        # Initially we don't have any books in list (none on loan)
...
class RenewBookInstancesViewTest(TestCase):
    def setUp(self):
        ...
        # Create a BookInstance for test_user1
...
class AuthorCreateViewTest(TestCase):
    ...
    def test_forbidden_if_logged_in_but_not_correct_permission(self):
        # A user with no permission should be forbidden
        User.objects.create_user(username='no_perm_user', password='some_password')
        login = self.client.login(username='no_perm_user', password='some_password')
        response = self.client.get(reverse('author-create'))
        self.assertEqual(response.status_code, 403)
    ...
    def test_redirects_to_detail_view_on_success(self):
        ...
        # Manually check redirect because we don't know the author id ahead of time
        self.assertEqual(response.status_code, 302)
